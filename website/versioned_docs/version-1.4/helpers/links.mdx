...
<Version version="1.0.0" source="glsass-helpers/_helpers.links.scss" />

By adding the `.h-stretched-link` class to a link, it make the "block" clickable
via a pseudo-element.<br/> To acheive it, the pseudo-element is stretched to
recover the nearest parent with `position: relative` property.
