...
By adding the `.u-stretched-link` class to a link, it make the "block"
...
<Example>
  <div className="o-row">
    <div className="o-col u-12 u-6@tb u-4@lg">
      <div className="c-card">
        ...
        <div className="c-card__footer">
          <a className="c-button c-button--primary u-stretched-link" href="#">
            Action
          </a>
        </div>
      </div>
...
<div class="c-card"><!-- the .u-pos-r is not required with the card component -->
  ...
  <div class="c-card__footer">
    <a class="c-button c-button--primary u-stretched-link" href="#">Link</a>
  </div>
</div>
````
<!-- prettier-ignore-end -->
