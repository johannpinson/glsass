...
You can also use utilities classes to create new behavior and layouts.
...
of the `.c-navbar` element with the `.c-navbar-layout` class.<br/>
Then, also add the `.o-layout` object to the new container element.
:::
