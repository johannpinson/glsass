...
<Version version="1.0.0" source="glsass-components/_components.card.scss" />

Cards are made to be flexible, for example to be used with or without some
children elements, and with different orders.
